...
export const recentMessages = [
    {
        id: 1,
        inmateId: 1, // Matches John D. Samuelson
        inmateName: "John D. Samuelson",
        subject: "Checking in",
        snippet: "Hope you are doing well. Just wanted to send a quick note...",
        date: "2024-06-10",
        read: false,
    },
    {
        id: 2,
        inmateId: 2, // Matches Maria Garcia
        inmateName: "Maria Garcia",
        subject: "Regarding the visit",
        snippet: "Looking forward to seeing you next weekend. I've added you to the list...",
        date: "2024-06-09",
        read: true,
    },
    {
        id: 3,
        inmateId: 3, // Matches Robert Smith
        inmateName: "Robert Smith",
        subject: "Book recommendation",
        snippet: "Finished the book you sent. It was great! Thanks for thinking of me...",
        date: "2024-06-08",
        read: true,
    },
    {
        id: 4,
        inmateId: 4, // Matches Chen Wei
        inmateName: "Chen Wei",
        subject: "Update on my case",
        snippet: "My lawyer visited today. We discussed the appeal process...",
        date: "2024-06-07",
        read: false,
    },
    {
        id: 5,
        inmateId: 5, // Matches Samantha Miller
        inmateName: "Samantha Miller",
        subject: "How are things?",
        snippet: "Just wanted to say hi and see how you're doing on the outside...",
        date: "2024-06-06",
        read: true,
    },
    {
        id: 6,
        inmateId: 6, // Matches Michael Johnson
        inmateName: "Michael Johnson",
        subject: "Mail received",
        snippet: "Got your letter today. It really brightened my day...",
        date: "2024-06-06",
        read: true,
    },   
];
